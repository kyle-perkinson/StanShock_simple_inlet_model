...
theta_flap_max = np.degrees(np.atan2((H_cc - L_flap*np.tan(np.radians(theta_noz))),L_flap))
...
A = lambda x, t: H(x,t)*W
dAdx = lambda x, t: W*dHdx(x,t)
dAdt = lambda x, t: W*dHdt(x,t)
dlnAdx = lambda x, t: dAdx(x,t) / A(x,t)
dlnAdt = lambda x, t: dAdt(x,t) / A(x,t)
